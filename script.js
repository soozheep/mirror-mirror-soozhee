const SITE_URL = 'https://mirror-mirror-soozhee.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Mirror Mirror — Sonic Remedy | Soozhee',
        text: 'Stop the pointing. Watch yourself soar. Mirror Mirror by Soozhee.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
